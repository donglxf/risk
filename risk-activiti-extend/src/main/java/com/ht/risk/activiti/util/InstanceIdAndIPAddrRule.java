package com.ht.risk.activiti.util;

import com.ht.risk.activiti.service.impl.ActProcReleaseServiceImpl;
...
public class InstanceIdAndIPAddrRule extends AbstractLoadBalancerRule {
    ...
    public Server choose(ILoadBalancer lb, Object key) {
        log.debug("InstanceIdAndIPAddrRule start...");
        String path = "";
        initHystrixRequestContext(defultInstanceId,defultExcludeInstanceId);
...
//                if (log.isInfoEnabled()) {
//                    log.debug("getIpAddress(HttpServletRequest) - getLocalHost - String ip=" + ip + " - getRemoteAddr " + request.getRemoteAddr());
//                }
            }
